      ...
      <div className="container-custom relative z-10 px-4 md:px-8 pt-32 pb-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-accent">Connecting You Smarter...</span>
          </motion.div>
          ...
          >
            From stunning websites to powerful marketing strategies, we help businesses 
            thrive in the digital age with cutting-edge solutions and creative excellence.
          </motion.p>
